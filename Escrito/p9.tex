\justify
\section{Relación entre carrera tentativa y carrera actual}
...
\begin{table}[H]
\begin{center}
	\caption{Relaciones encontradas por los estudiantes de la UVG entre la carrera de etapa tentativa y la carrera actual.}
...
\begin{math}
	P_{1} = \frac{89}{290}; P_{2} = \frac{16}{174};
\end{math}
...
\end{math}\\
\begin{math}
	P_{1} = \frac{191}{290}; P_{2} = \frac{16}{174};
\end{math}\\
\begin{math}
	\alpha = 0.05;
\end{math}\\
...
\end{math}\\
\begin{math}
	P_{1} = \frac{184}{290}; P_{2} = \frac{56}{174} ;
\end{math}\\
\begin{math}
	\alpha = 0.05;
\end{math}\\
...
\end{math}\\
\begin{math}
	P_{1} = \frac{37}{290}; P_{2} = \frac{16}{174} ;
\end{math}\\
\begin{math}
	\alpha = 0.05;
\end{math}\\
...
\end{math}\\
\begin{math}
	P_{1} = \frac{54}{290}; P_{2} = \frac{16}{174};
\end{math}\\
\begin{math}
	\alpha = 0.05;
\end{math}\\
