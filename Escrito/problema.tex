...
Con base en esto, se ha decidido formular la siguiente pregunta de investigación: \textquestiondown Cu\'{a}l es la relaci\'{o}n entre la profesión deseada durante la etapa tentativa y la carrera universitaria escogida de los estudiantes de la \textbf{Universidad del Valle de Guatemala}?\\
...
\begin{itemize}
	...
	\item \textquestiondown Cuales son las profesiones de etapa tentativa más comunes entre los estudiantes de la Universidad del Valle de Guatemala?
	\item \textquestiondown Qu\'{e} concepto tiene la sociedad acerca de las carreras de etapa tentativa de los j\'{o}venes en general?
	\item \textquestiondown Cuales son las limitaciones que tienen las carreras deseadas durante la etapa tentativa de los estudiantes?
