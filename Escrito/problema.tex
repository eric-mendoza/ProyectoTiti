...
En base a lo anterior, se ha decidido formular la siguiente pregunta de investigación: \textquestiondown Cu\'{a}l es la relaci\'{o}n entre la profesión deseada durante la etapa tentativa y la carrera universitaria escogida de los estudiantes de la \textbf{Universidad del Valle de Guatemala}?\\

Asimismo, este trabajo de investigación se encontrará guiado por las siguientes preguntas auxiliares: 

\begin{itemize}
	\item \textquestiondown Qu\'{e} porcentaje de alumnos estudian la carrera universitaria que desearon durante la etapa tentativa?
	\item \textquestiondown Qu\'{e} factores afectan la elección de una carrera universitaria?
	\item \textquestiondown Cuáles son las profesiones de etapa tentativa más comunes entre los estudiantes de la Universidad del Valle de Guatemala?
	\item \textquestiondown Qu\'{e} relaci\'{o}n existe entre el sexo del estudiante y su carrera deseada durante la etapa tentativa?
\end{itemize}
...
\begin{itemize}
	...
	\item Encargados en contra de la carrera deseada por el estudiante, quit\'{a}ndole todo el apoyo moral por seguirla. 
...
%\textquestiondown Cu\'{a}l es la relaci\'{o}n entre la profesión deseada durante la etapa tentativa y la carrera universitaria escogida de los estudiantes de la \textbf{Universidad del Valle de Guatemala}?\\
